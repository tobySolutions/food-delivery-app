    ...
    <section className='grid grid-cols-1 md:grid-cols-2 gap-2 w-full' id="home">
      <div className='py-2 flex-1 flex flex-col items-start justify-start gap-6'>
        ...
        <p className="text-base text-textColor text-center md:text-left md:w-[80%]">
          Lorem ipsum dolor sit, amet consectetur adipisicing elit. Similique quisquam vel beatae, hic impedit blanditiis, iure reiciendis distinctio vero amet nostrum eaque iusto aliquid corrupti quas ducimus adipisci praesentium animi.
        </p>
      ...
      <div className='py-2 flex-1 flex items-center relative'>
              <img
                ...
                alt="hero-bg"
              />
              <div className="w-full h-full absolute top-0 left-0 flex-wrap flex items-center lg:px-4 py-4 gap-4 justify-center drop-shadow-lg">
                {
                heroData && heroData.map(n => (
                  <div key={n.id} className='lg:w-190  p-4 bg-red-400 bg-cardOverlay backdrop-blur-md rounded-3xl flex flex-col items-center justify-center'>
